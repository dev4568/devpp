...
import { alertUtils, paymentAPI, documentsAPI, userAPI } from '@/utils/apiService';
    ...
    <Card className="max-w-2xl mx-auto m-4">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 mt-6">
          ...
          <Button onClick={handleLoginTest} className="col-span-2" variant="outline" size="sm">
            Test Login API
          </Button>
        </div>

        <div className="text-sm text-gray-600 mt-4">
          <p><strong>Note:</strong> This demo component showcases:</p>
