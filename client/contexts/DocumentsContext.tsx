...
export function DocumentsProvider({ children }: DocumentsProviderProps) {
  ...
  const addFiles = async (files: File[]): Promise<void> => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: 'Error storing files. Please try again.' });
    } finally {
      dispatch({ type: 'SET_LOADING', payload: false });
    }
  };
  ...
  const removeFile = async (id: string): Promise<void> => {
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: 'Error removing file. Please try again.' });
    }
  };
  ...
  const updateFileDocumentType = async (id: string, documentTypeId: string): Promise<void> => {
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: 'Error updating document type. Please try again.' });
    }
  };
  ...
  const updateFileTier = async (id: string, tier: string): Promise<void> => {
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: 'Error updating tier. Please try again.' });
    }
  };
  ...
  const clearAllFiles = async (): Promise<void> => {
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: 'Error clearing files. Please try again.' });
    }
  };
  ...
  const restoreFiles = async (): Promise<void> => {
    ...
    try {
      ...
      dispatch({ type: 'SET_ERROR', payload: 'Error restoring files from storage.' });
    } finally {
      dispatch({ type: 'SET_LOADING', payload: false });
    }
  };
